...
| File | Role |
|------|------|
| `app.js` | CLI entry, orchestrates pipeline, supports `--check` mode; one merged write-time confirmation covers property updates + any pending LLM review (`--apply` auto-accepts) |
