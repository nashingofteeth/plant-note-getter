...
const TESTS = [
  ...
  {
    name: 'Hibiscus mutabilis (Pattern P — "Alternative names ... are X and Y")',
  ...
  {
    name: 'Calystegia silvatica (Pattern A parens not mistaken for scientific name; Pattern F section)',
  ...
  {
    name: 'Centaurea cyanus (Pattern F — "Other names include" without "common")',
