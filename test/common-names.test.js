...
const TESTS = [
  ...
  {
    name: 'Cichorium intybus (named-subject "is also known as" list; "(or witlof)" paren alternative; Cornflower Gloss for Centaurea rejected)',
